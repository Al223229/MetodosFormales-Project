...
// --- 2. Crear un componente Link animable ---
const MotionLink = motion(Link);

export default function VerifyAccount() {
  
  // --- 3. Definir variantes de animación ---
  ...
  const contentStagger = {
    ...
    visible: { 
      opacity: 1,
      transition: { 
        staggerChildren: 0.08, // Tiempo entre cada item
        delayChildren: 0.3 // Espera a que la tarjeta suba
      } 
    }
  };
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#fcfbf5]">
      ...
      <main className="flex-grow flex items-start justify-center px-4 -mt-40 pb-10">
        {/* --- MODIFICADO: Tarjeta principal con animación --- */}
        <motion.div 
        ...
        >
          ...
          {/* --- MODIFICADO: Contenedor Stagger para el contenido --- */}
          <motion.div
